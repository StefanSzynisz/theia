function [E_return,nu_return,Linf] = inverse_problem_2x2_elems_ES(strain,P_arg,varargin)
...
%
% Example Usage:
%         [U,eps,sig] = forward_problem_2x2_elems_ES([25 35 15 15],[0.2 0.2 0.2 0.2],-3)
%
