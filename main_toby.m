...
% *****************************
pressure = -9.868*10^6;                                                     % pressure in [Pa]
element_size = 0.00238;                                                     % physical length (of pixel) in [m] or other consistent units
bc_type = 'pressure';                                                       % type of boundaries at the bottom: 'pressure' or 'roller' or 'fixed'
   
%% Read strain inputs:
%****************************
% readCSVfile
epsA = xlsread('data\timber_toby\strains_at_30kN.csv');                     % strain input: xx, yy, xy
epsA = epsA(:,1:end);
% reshape_the_data;
% Check the data
...
% *************************************************************************
nels_x = 25;                                                                % number of elements in the x direction
nels_y = 165;                                                               % number of elements in the y direction
% **************
...
E_init = abs(pressure / eps_yy_avg);                                            % average Young modulus
